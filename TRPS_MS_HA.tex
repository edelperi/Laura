...
%% Eugenio: Esta tabla es redundante con la figuras 9 y 10 yo la pondría en información suplementaria.
%\begin{table}
%\label{tbl:sizes}
...
%Alternatively DOM can be removed from samples  before the TRPS determination.
