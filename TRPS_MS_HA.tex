...
%%============================================================= 
%Esta fogura se elimina y los resultdos 
 %\begin{figure}
...
%Recall that 
%$\mathrm{[HA] =\; 2\; mg\,L^{-1}}$
%was about 3 times the stoichometric rate required for  coating the MS with a monolayer of HA.
% comentado Eugenio
...
%There is an apparent increase of the particle size in the interval of [HA] $4-10~\mathrm{mg\,L^{-1}}$. This rate of increase in diameter with the [HA]  was $4.6\,\pm 1.8~\mathrm{nm\,L\,mg^{-1}}$, with a $\mathrm{P = 0.027}$ $r^2 > 0.635$ and 11 degrees of freedom. 
%That confirms that the apparent size of particles in the cluster no. 2 increases significantly with the [HA], and the growth rate manifests at $16~\mathrm{h}$ incubation.
...
%At short times, $0.25~\mathrm{h}$, there was a monotonic increase in size with the [HA] in the range $2-8~\mathrm{mg\,L^{-1}}$. At larger contact times, $16-40~\mathrm{h}$, the size increased dramatically with a maximum at $\mathrm{[HA]} = 2~\mathrm{mg\,L^{-1}}$. Then, at higher [HA] the size  diminished with an uniform decrease that can be clearly observed at $40~\mathrm{h}$. The highest size, $1462~\mathrm{nm}$, was measured with $\mathrm{[HA]} = 2~\mathrm{mg\,L^{-1}}
